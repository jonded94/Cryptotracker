...
class SimpleTableCell(object):
    ...
    def __init__(self, text, header=False, colspan=1):
    ...
    def __str__(self):
        ...
        if self.header:
            return '<th colspan=%d>%s</th>' %(self.colspan, self.text)
        else:    
            return '<td colspan=%d>%s</td>' %(self.colspan, self.text)
...
class SimpleTableRow(object):
    ...
    """
    def __init__(self, cells=[], header=False, header_colspan=1):
        ...
        if isinstance(cells[0], SimpleTableCell):
            ...
            self.cells = [SimpleTableCell(cell, header=header, colspan=header_colspan) for cell in cells]
...
class SimpleTable(object):
    ...
    """
    def __init__(self, rows=[], header_row=None, css_class=None, header_colspan=1):
        """Table constructor.
        ...
        if header_row is None:
            ...
            self.header_row = SimpleTableRow(header_row, header=True, header_colspan=header_colspan)
    ...
    def __str__(self):
        ...
        if self.css_class:
            table.append('<center><table class=%s>' % self.css_class)
        else:
            table.append('<table>')
